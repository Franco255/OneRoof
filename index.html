...
<head>
    ...
    <!-- Page Title -->
    <title>One roof- all in one place</title>
  ...
  <symbol id="youtube" viewBox="0 0 24 24"><path d="M23.6 6.3c-.3-1.2-1.4-2.2-2.6-2.3-3-.3-6-.3-9-.3s-6 0-9 .3c-1.2.1-2.3 1.1-2.6 2.3-.4 1.8-.4 3.8-.4 5.7 0 1.9 0 3.9.4 5.7.3 1.2 1.4 2.2 2.6 2.3 3 .3 6 .3 9 .3s6 0 9-.3c1.3-.1 2.3-1.1 2.6-2.4.4-1.7.4-3.7.4-5.6 0-1.9 0-3.9-.4-5.7zm-14.1 9v-6.6l6.5 3.3-6.5 3.3z"/></symbol>
    ...
    <nav class="panel top">
        <div class="sections desktop">
            ...
            <div class="left">
                <a href="#"><img src="assets/img/one1.svg" width="10%" alt="" /> </a>
            </div>
            <div class="center">
                <ul class="menu">
                    <li><a href="#">Home</a></li>
        ...
        <div class="sections compact hidden">
            <div class="left"><a href="#" title="Slides Framework"><svg style="width:82px;height:24px"><img src="assets/img/one1.svg" width="20%"  alt=""/></svg></a></div>
            <div class="right"><span class="button actionButton sidebarTrigger" data-sidebar-id="1"><svg><use xmlns:xlink="file:///C:/Users/dell/Desktop/slides-master/slides-master/slides-master/assets/img/oneroofwhite.svg" xlink:href="#menu"></use></svg></span</div>
  </div>
</nav>
...
<section class="slide fade-6 kenBurns">
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-12-12">
          <ul class="flex fixedSpaces verticalCenter reverse">
            <li class="col-6-12 left middle">
              <h1 class="ae-1 fromLeft">Welcome to One Roof web presentation.</h1>
              <p class="ae-2 fromLeft"><span class="opacity-8">The sudden hunch, the creative leap of mind that “sees” in a flash how to solve a problem in a simple way, is something quite&nbsp;different.</span></p>
                ...
                <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiRk4eJ_IDzAhWIxIUKHQbkBPsQFnoECAQQAQ&url=https%3A%2F%2Fwww.apple.com%2Fapp-store%2F&usg=AOvVaw1Lcoy66QyqCeLXr3v7zX_r" class="button hollow ae-5"><img src="assets/img/appstore1.png" height="63" /></a>
                <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjF-6Lk-4DzAhUDgVwKHU5LA2QQFnoECAwQAw&url=https%3A%2F%2Fplay.google.com%2F&usg=AOvVaw17R4zYMafohnWwu5zSuX94" class="button hollow ae-6"><img src="assets/img/googleplay1.jpg" height="63" /></a>
                </li>
                <li class="col-5-12">
                    <img class="ae-4" width="605" src="assets/img/iphones-3412.png" alt="iPhones Thumbnail" data-action="zoom" />
                </li>
                </ul>
            </div>
        ...
        <div class="background" style="background-image:url(assets/img/background/circles.jpg)"></div>
  ...
  <div class="background" style="background-image:url(assets/img/background/chairs.jpg)"></div>
</section>
...
--->
        ...
        <section class="slide fade-6 kenBurns" data-name="features">
                        ...
                        <div class="fix-12-12">
                            <ul class="flex verticalCenter">
                                <li class="col-5-12 cell-27">
                                    <div class="fix-4-12">
                                        <ul class="slider clickable ae-1 fromAbove" data-slider-id="27-2">
                                            <li class="selected"><img src="assets/img/iphones-341 sms.png" alt="Apple Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341 sms.png" alt="Apple Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341 sms.png" alt="Apple Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341 sms.png" alt="Apple Watch Thumbnail" /></li>
                                        </ul>
                                ...
                                <li class="col-7-12 left">
                                    <h1 class="ae-2 fromRight">Chats</h1>
                                    <div class="ae-3 fromRight">
                                        <p class="opacity-8">Presence of in-built message feature, gives the application on of the outstanding feature. fast and quickest way to get in contact with the respective business owner.&nbsp;better.</p>
                                    </div>
                                    <!--<div class="relative">
                <img src="assets/img/icon-2.png" class="ae-3 fromCenter app-26" alt="app"/>
                <div class="text-26">
                  <h3 class="ae-3 fromRight">Ember with your device</h3>
                  <div class="ae-5 fromRight">
                    <p class="tiny opacity-6">People don&rsquo;t use a product<br>because of the great&nbsp;design.</p>-->

                                    <!-- <a href="#" class="button hollow ae-5"><img src="assets/img/appstore1.png" height="63"/></a><a href="#" class="button hollow ae-6"><img src="assets/img/googleplay1.jpg" height="63"/></a>-->
                        </div>
                    </div>
                </div>
                </li>
            ...
            <div class="background" style="background-image:url(assets/img/background/img-271.jpg)"></div>
        </section>
                        ...
                        <div class="fix-12-12">
                            <ul class="flex reverse verticalCenter">
                                <li class="col-7-12 left cell-26">
                                    <h1 class="ae-1 fromLeft">Profile Management</h1>
                                    <div class="ae-2 fromLeft">
                                        <p class="opacity-8">With this feature feel free to visit your profile and customize it as you wish &nbsp;society.</p>
                                    </div>
                                    <div class="relative">
                                ...
                                <li class="col-5-12">
                                    <div class="fix-4-12 center">
                                        <ul class="slider clickable ae-1 fromAbove" data-slider-id="26-3">
                                            <li class="selected"><img src="assets/img/iphones-341profile.png" alt="Image Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341profile.png" alt="Image Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341profile.png" alt="Image Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341profile.png" alt="Image Thumbnail" /></li>
                                        </ul>
            ...
            <div class="content">
                <div class="container">
                        ...
                        <div class="fix-12-12">
                            <ul class="flex verticalCenter">
                                <li class="col-5-12 cell-27">
                                    <div class="fix-4-12">
                                        <ul class="slider clickable ae-1 fromAbove" data-slider-id="27-2">
                                            <li class="selected"><img src="assets/img/iphones-341 book.png" alt="Apple Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341 book.png" alt="Apple Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341 book.png" alt="Apple Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341 book.png" alt="Apple Watch Thumbnail" /></li>
                                        </ul>
                                        <ul class="controller dots ae-2 fromCenter margin-top-3" data-slider-id="27-2">
                  ...
                  <li class="dot"></li>-->
                                ...
                                <li class="col-7-12 left">
                                    <h1 class="ae-2 fromRight">Booking</h1>
                                    <div class="ae-3 fromRight">
                                        <p class="opacity-8">keep track of what your have in mind with booking feature, here you can see all the activity that require payment and those that have already been paid for.&nbsp;better.</p>
                                    </div>
                                    <!--<div class="relative">
                <img src="assets/img/icon-2.png" class="ae-3 fromCenter app-26" alt="app"/>
                <div class="text-26">
                ...
                <div class="container">
                    <div class="wrap">
                        ...
                        <div class="fix-12-12">
                            <ul class="flex reverse verticalCenter">
                                <li class="col-7-12 left cell-26">
                                    <h1 class="ae-1 fromLeft">Home</h1>
                                    <div class="ae-2 fromLeft">
                                ...
                                <li class="col-5-12">
                                    <div class="fix-4-12 center">
                                        <ul class="slider clickable ae-1 fromAbove" data-slider-id="26-3">
                                            <li class="selected"><img src="assets/img/iphones-341home.png" alt="Image Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341home.png" alt="Image Watch Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341home.png" alt="Image Thumbnail" /></li>
                                            <li><img src="assets/img/iphones-341home.png" alt="Image Thumbnail" /></li>
                                        </ul>
                                        <ul class="controller dots ae-3 fromCenter margin-top-3" data-slider-id="26-3">
                                            <!--<li class="dot selected"></li>
  ...
  <div class="background" style="background-image:url(assets/img/background/img-83.jpg)"></div>
        ...
        <!-- Slide 7 (#95) -->
        <section class="slide fade-6 kenBurns" data-name="contactus">
            <div class="content">
                ...
                <div class="container">
                    <div class="wrap">
                        ...
                        <div class="">
                            <h1 class="huge ae-1 margin-bottom-2">For more details</h1>
                            <p class="hero ae-2 margin-bottom-3"><span class="opacity-8">Get in touch with us</span></p>
                            ...
                            <div class="">
                                ...
                                <form action="#" autocomplete="off" class="slides-form1 margin-bottom-5">




                                    <!-- <label for="firstName" class="form-lable">FirstName</label> -->
                                    <!--<label for="firstName" class="form-lable left position-relative">Get in touch with us.</label> &nbsp;-->
                                    <input type="text" class="form-control" style=" height: 45px; width: 30%; border-radius: 6px;" id="firstName" placeholder="FirstName" required class="">




                                    <input type="text" class="form-control" style=" height: 45px; width: 30%; border-radius: 6px;" id="LastName" placeholder="LastName" required class="right">





                                    <div class="col-5-12 " style="margin: 5px;">
                                        <input type="email" class="form-control" style=" height: 45px; width: 30%; border-radius: 6px;" id="emailinfo" placeholder="E-mail" required="">


                                        <input type="number" class="form-control" style=" height: 45px; width: 30%; border-radius: 6px;" id="phonenumber" placeholder="+255">
                                    </div>
                                    <br>
                        ...
                        <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiRk4eJ_IDzAhWIxIUKHQbkBPsQFnoECAQQAQ&url=https%3A%2F%2Fwww.apple.com%2Fapp-store%2F&usg=AOvVaw1Lcoy66QyqCeLXr3v7zX_r " class="button
                                        hollow ae-5 "><img src="assets/img/appstore1.png " height="63 " /></a>
                        <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjF-6Lk-4DzAhUDgVwKHU5LA2QQFnoECAwQAw&url=https%3A%2F%2Fplay.google.com%2F&usg=AOvVaw17R4zYMafohnWwu5zSuX94 " class="button hollow
                                        ae-6 "><img src="assets/img/googleplay1.jpg " height="63 " /></a>
                    </div>

                </div>
            </div>
            </div>
            <div class="background " style="background-image:url(assets/img/background/back.jpg) "></div>
        </section>
